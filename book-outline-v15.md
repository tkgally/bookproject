# The Archaeology of Deleted Ideas: Book Outline and Writing Plan (v15)
...
10. `book-outline-v15.md` - This master project guide (ACTIVE - updated May 25, 2025)
11. `Phase 1 report - Gemini.md` - Theoretical foundations research (COMPLETED)
12. `Phase 1 report - ChatGPT.md` - Theoretical foundations research (COMPLETED)
13. `Phase 2-1 Vanished Technologies ChatGPT.md` - Lost technology cases (COMPLETED)
14. `Phase 2-1 Vanished Technologies Gemini.md` - Lost technology cases (COMPLETED)
15. `Phase 2-2 2-3 2-4 Detailed Analyses ChatGPT.md` - Comprehensive case analyses (COMPLETED)
16. `Phase 2-2 2-3 2-4 Detailed Analyses Gemini.md` - Comprehensive case analyses (COMPLETED)
17. `Archaeology of Deleted Ideas - Claude.md` - Additional research (COMPLETED)
18. `Archaeology of Deleted Ideas - Gemini.md` - Additional research (COMPLETED)
19. `Archaeology of Deleted Ideas - ChatGPT.md` - Additional research (COMPLETED)
20. `Book project record - ignore.md` - Administrative file
21. `AIDEA-LING-01-LinguisticRelativity.md` - Linguistic relativity findings (COMPLETED May 23, 2025)
22. `AIDEA-LING-02-LanguageExtinction.md` - Language death analysis (COMPLETED May 23, 2025)
23. `AIDEA-LING-03-ScriptLoss.md` - Writing systems and decipherment (COMPLETED May 23, 2025)
24. `AIDEA-LING-04-MethodsReconstruction.md` - Linguistic reconstruction methods (COMPLETED May 23, 2025)
25. `AIDEA-LING-05-UntranslatableConcepts.md` - Untranslatable concepts analysis (COMPLETED May 23, 2025)
26. `AIDEA-PHIL-01-PhilosophyOfAbsence.md` - Philosophy of conceptual extinction (COMPLETED May 23, 2025)
27. `AIDEA-PHIL-02-TranslationPhilosophy.md` - Philosophy of translation and untranslatability (COMPLETED May 23, 2025)
28. `AIDEA-PHIL-03-LanguageThoughtPhilosophy.md` - Philosophy of language and thought (COMPLETED May 23, 2025)
29. `AIDEA-PHIL-04-EthicsMethodologyPhilosophy.md` - Ethical and methodological philosophy (COMPLETED May 23, 2025)
30. `AIDEA-PHIL-05-Agnotology.md` - The active production of ignorance (COMPLETED May 24, 2025)
31. `AIDEA-PHIL-06-FoucaultArchaeology.md` - Foucault's archaeological method (COMPLETED May 24, 2025)
32. `AIDEA-PHIL-07-OntologyOfConceptualExtinction.md` - Ontology of conceptual death (COMPLETED May 24, 2025)
33. `AIDEA-PHIL-08-ConceptualEngineeringPreservation.md` - Active preservation philosophy (COMPLETED May 24, 2025)
34. `AIDEA-TECH-01-LostMaterials.md` - Lost materials and properties (COMPLETED May 24, 2025)
35. `AIDEA-TECH-02-VanishedProcesses.md` - Vanished manufacturing processes (COMPLETED May 24, 2025)
36. `AIDEA-TECH-03-ForgottenEngineeringKnowledge.md` - Forgotten engineering principles (COMPLETED May 24, 2025)
37. `AIDEA-TECH-04-TechnologicalTransmissionFailures.md` - Knowledge transmission failures (COMPLETED May 24, 2025)
38. `AIDEA-TECH-05-EconomicImpacts.md` - Economic impacts of technological loss (COMPLETED May 24, 2025)
39. `AIDEA-TECH-06-RecoveryRediscovery.md` - Recovery and rediscovery methods (COMPLETED May 24, 2025)
40. `AIDEA-INDIG-01-IndigenousEcologicalKnowledge.md` - Overview of IEK systems (COMPLETED May 24, 2025)
41. `AIDEA-INDIG-02-TraditionalManagementPractices.md` - Fire and agricultural management (COMPLETED May 24, 2025)
42. `AIDEA-INDIG-03-EthnobotanicalKnowledge.md` - Medicinal and botanical knowledge (COMPLETED May 24, 2025)
43. `AIDEA-INDIG-04-AstronomicalNavigationalKnowledge.md` - Celestial and navigation systems (COMPLETED May 24, 2025)
44. `AIDEA-INDIG-05-TransmissionMethods.md` - Knowledge transmission processes (COMPLETED May 24, 2025)
45. `AIDEA-INDIG-06-ThreatsAndRevitalization.md` - Modern threats and revival efforts (COMPLETED May 24, 2025)
46. `AIDEA-ECON-01-EconomicImpactsOfLostTechnology.md` - Direct economic consequences (COMPLETED May 24, 2025)
47. `AIDEA-ECON-02-InnovationCostsAndOpportunityLosses.md` - Foregone innovation analysis (COMPLETED May 24, 2025)
48. `AIDEA-ECON-03-QuantitativeAnalysesOfKnowledgeLoss.md` - Measurable impacts (COMPLETED May 24, 2025)
49. `AIDEA-ECON-04-EconomicTheoriesOfConceptualExtinction.md` - Economic frameworks (COMPLETED May 24, 2025)
50. `AIDEA-ECON-05-EconomicImpactsOfKnowledgeSystems.md` - System-level economics (COMPLETED May 24, 2025)
51. `AIDEA-ECON-06-IndigenousEcologicalKnowledgeEconomics.md` - IEK economic dimensions (COMPLETED May 24, 2025)
52. `AIDEA-ECON-07-EconomicFactorsInKnowledgeTransmission.md` - Transmission economics (COMPLETED May 24, 2025)
53. `AIDEA-ECON-08-ComparativeEconomicAnalyses.md` - Comparative frameworks (COMPLETED May 24, 2025)
54. `AIDEA-METH-01-DetectionMethods.md` - Core detection techniques (COMPLETED May 24, 2025)
55. `AIDEA-METH-02-InterdisciplinaryApproaches.md` - Cross-disciplinary integration (COMPLETED May 24, 2025)
56. `AIDEA-METH-03-DigitalComputationalMethods.md` - Digital humanities approaches (COMPLETED May 24, 2025)*
57. `AIDEA-METH-04-ChallengesLimitations.md` - Methodological obstacles (COMPLETED May 24, 2025)
58. `AIDEA-METH-05-InnovativeIntegratedApproaches.md` - Cutting-edge methods (COMPLETED May 24, 2025)*
59. `AIDEA-METH-06-EthicalConsiderations.md` - Ethical framework (COMPLETED May 24, 2025)
60. `AIDEA-CASE-01-Chapter1Cases.md` - Introductory cases for Chapter 1 (COMPLETED May 24, 2025)
61. `AIDEA-CASE-02-Chapter2Cases.md` - Language-thought nexus cases (COMPLETED May 24, 2025)
62. `AIDEA-CASE-03-Chapter3Cases.md` - Mechanisms of deletion cases (COMPLETED May 24, 2025)
63. `AIDEA-CASE-04-Chapter4Cases.md` - Detection methods cases (COMPLETED May 24, 2025)
64. `AIDEA-CASE-05-Chapter5Cases.md` - Vanished technologies cases (COMPLETED May 24, 2025)
65. `AIDEA-CASE-06-Chapter6Cases.md` - Indigenous knowledge cases (COMPLETED May 24, 2025)
66. `AIDEA-CASE-07-Chapter7Cases.md` - Philosophy of absence cases (COMPLETED May 24, 2025)
67. `AIDEA-CASE-08-Chapter8Cases.md` - Translation cases (COMPLETED May 24, 2025)
68. `AIDEA-CASE-09-Chapter9Cases.md` - Quest for recovery cases (COMPLETED May 24, 2025)
69. `AIDEA-CASE-10-Chapter10Cases.md` - Cognitive diversity cases (COMPLETED May 25, 2025)
70. `AIDEA-CASE-11-Chapter11Cases.md` - Ethics cases (COMPLETED May 25, 2025)
71. `AIDEA-CASE-12-Chapter12Cases.md` - Future approaches cases (COMPLETED May 25, 2025)
...
### Phase 3: Research Documentation and Note Compilation (COMPLETED)
...
- Current task: Move to Phase 3.9 (DIGIT) or skip to Phase 3.10 (TRANS) given de-emphasis on digital
- Next conversation should provide research files for the next phase
