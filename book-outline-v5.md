# The Archaeology of Deleted Ideas: Book Outline and Writing Plan (v5)
...
1. `book-outline-v5.md` - This master project guide (ACTIVE)
...
- Current task: Phase 3.2 - LING (Linguistics) extraction
- Next conversation should start with Phase 3.2
